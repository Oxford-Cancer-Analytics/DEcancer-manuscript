...
class DecisionTree(Model):
    """A class for the Decision Tree which extends the Model class."""
    ...
    def __init__(
        ...
        params: Sequence[Parameter] = [Parameter(DecisionTreeClassifier)],
    ):
        super().__init__(data)
    ...
    def train_rfe(
        ...
        **hyperparameters: Mapping[str, Any],
        ...
        """Trains a recursive Decision Tree model.
