...
class MultiLayerPerceptron(Model):
    """A class for the MLPClassifier which extends the Model class."""
    ...
    def __init__(
        ...
        params: Sequence[Parameter] = [Parameter(MLPClassifier)],
    ):
        super().__init__(data)
    ...
    def train_rfe(
        ...
        **hyperparameters: Mapping[str, Any],
        ...
        """Trains a recursive Multi-Layer Perceptron model.
